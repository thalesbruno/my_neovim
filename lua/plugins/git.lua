return {
	{
		...
		config = function()
			...
			vim.keymap.set(
				...
				{ desc = "Gitsigns: reset the entire file" }
			)
	...
	},
	{
		...
		config = function()
			...
			end, { desc = "Git diffview: open file diff view" })
			...
			vim.keymap.set("n", "<leader>gh", function()
				...
				vim.cmd("DiffviewFileHistory " .. vim.fn.fnameescape(file) .. " --no-merges")
			end, { desc = "Git diffview: view file history" })
		end,
	},
}
